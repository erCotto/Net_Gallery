...
<div id="main_content">
  ...
  <div id="page_content">
    ...
    echo "<h1 style=text-align:center;>Page de gestion des visiteurs</h1>";

    $vis_id = $_POST['vis_id'];
    echo "vis_id = ". $vis_id ."<br>";

    $suppr_1 = "delete from t_commentaire_com where vis_id = ". $vis_id .";";
    $suppr_2 = "delete from t_visiteurs_vis where vis_id = ". $vis_id .";";
    echo $suppr_1 ."<br>";
    echo $suppr_2 ."<br>";
    $r_suppr_1 = $mysqli->query($suppr_1);
    $r_suppr_2 = $mysqli->query($suppr_2);
